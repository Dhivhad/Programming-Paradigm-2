...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
      ...
      // Create and configure the eyebrows
        Line rightEyebrow = new Line(72, 80, 100, 70);
        rightEyebrow.setStroke(Color.BLUE);
        Line leftEyebrow = new Line(138, 70, 166, 80);
        leftEyebrow.setStroke(Color.BLUE);
       ...
       shockButton.setOnAction(e-> mouth.setLength(360));
